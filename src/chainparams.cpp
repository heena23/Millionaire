...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.millionaire.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.millionairetools.com", true);
        vSeeds.emplace_back("dnsseed.millionairepool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.millionairetools.com", true);
        vSeeds.emplace_back("seed-b.millionaire.loshan.co.uk", true);
