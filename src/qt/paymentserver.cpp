...
const QString BITCOIN_IPC_PREFIX("millionaire:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/millionaire-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/millionaire-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/millionaire-paymentrequest";
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start millionaire: click-to-pay handler"));
        }
        else {
