...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and millionaire: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a millionaire: URI or payment request"));
