...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s millionaire-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  millionaire-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded millionaire transaction") + "\n" +
              "  millionaire-tx [options] -create [commands]   " + _("Create hex-encoded millionaire transaction") + "\n" +
              "\n";
