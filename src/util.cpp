...
const char * const BITCOIN_CONF_FILENAME = "millionaire.conf";
const char * const BITCOIN_PID_FILENAME = "millionaire.pid";
...
#else
    const char* pszModule = "millionaire";
#endif
    if (pex)
        return strprintf(
